...
export const metadata: Metadata = {
  title: "Taif Airport Taxi — Private Transfers | Saudia Cabs",
  description:
    "Private taxi transfers from Taif Airport to your hotel or destination in the city. 24/7 service, fixed price, professional drivers. Book on WhatsApp +966 59 894 7503.",
  keywords: [
    "taif airport taxi",
  ...
  alternates: { canonical: "https://saudiacabs.com/services/airport-transfer/taif/" },
  openGraph: {
    title: "Taif Airport Taxi — Saudia Cabs",
    description: "Private airport transfers in Taif. 24/7, fixed price, professional drivers. Book on WhatsApp.",
    url: "https://saudiacabs.com/services/airport-transfer/taif/",
  },
};

const faqs = [
  { q: "Do you provide taxi service from Taif Airport?", a: "Yes. We provide private transfers from Taif Airport to your hotel or destination in the city. WhatsApp us your flight details and passenger count for a fixed quote." },
  { q: "How do I book a Taif Airport transfer?", a: "WhatsApp us at +966 59 894 7503 with your flight number, arrival date, number of passengers and destination — we confirm within minutes." },
  { q: "What vehicles are available in Taif?", a: "We offer the same fleet available across our other cities — from a 4-seater sedan to a 17-seater coaster — depending on your group size." },
  { q: "Are your Taif Airport prices fixed?", a: "Yes. We agree the price with you upfront on WhatsApp before booking — no meters, no hidden charges." },
];

export default function TaifAirportTransferPage() {
  return (
    <>
      <ServiceSchema
        name="Taif Airport Taxi"
        description="Private taxi transfers from Taif Airport to hotels and destinations across the city."
        url="/services/airport-transfer/taif/"
      />
      <BreadcrumbSchema items={[
        { name: "Home", url: "/" },
        { name: "Services", url: "/services/" },
        { name: "Airport Transfer", url: "/services/airport-transfer/" },
        { name: "Taif Airport", url: "/services/airport-transfer/taif/" },
      ]} />
      <FAQSchema faqs={faqs} />
      <Header />
      <main>
        ...
        <section style={{ backgroundColor: "#184A27", padding: "64px 0 56px" }}>
          <div className="container">
            <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "12px", flexWrap: "wrap" }}>
              ...
              <span style={{ color: "rgba(255,255,255,0.5)", fontSize: "14px" }}>/</span>
              <span style={{ color: "#fff", fontSize: "14px" }}>Taif Airport</span>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "20px" }}>
              ...
              <h1 style={{ color: "#fff", fontSize: "40px", fontWeight: "700" }}>Taif Airport Taxi</h1>
            </div>
            <p style={{ color: "rgba(255,255,255,0.85)", fontSize: "18px", maxWidth: "640px", lineHeight: "1.75" }}>
              Private transfers from Taif Airport to your hotel or destination in the city.
        ...
        <section style={{ backgroundColor: "#184A27", padding: "56px 0" }}>
          <div className="container" style={{ textAlign: "center" }}>
            <h2 style={{ color: "#fff", marginBottom: "16px" }}>Book Your Taif Airport Transfer</h2>
